...
import { IconHeart, IconHeartFilled, IconShoppingCartPlus, IconStarFilled } from '@tabler/icons-vue';
...
<template>
  <article class="border border-black/20 rounded-lg overflow-hidden p-2">
    <div class="rounded-xl overflow-hidden relative aspect-16/12 bg-gray-300">
      <img class="size-full object-cover -z-10" :src="product.thumbnail" :alt="`image of ${product.title}`">
    ...
    <div class="p-2 mt-1">
      ...
      <div class="flex justify-between items-center">
        ...
        <button class="flex items-center gap-2 border-2 p-2 px-4 rounded-lg cursor-pointer hover:text-white hover:bg-black transition-colors">
          <IconShoppingCartPlus class="sm:hidden md:inline-block" />
